...
import { Form, Input, Button, Tag, message, Select } from 'antd'; // 引/入 Ant Design 组件
import { createNote } from '@/api/noteApi'; // 引/入创建笔记的 API
import { getCategories } from '@/api/categoryApi'; // 引/入获取分类的 API
